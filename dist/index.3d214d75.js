...
if (formInputValue.length === 0) formDiv.innerHTML = "<p class='form__p-empty'>Start Writing Here...</p>";
optionBold.addEventListener("click", ()=>{
    currentInputStackLength = formInputValue.length;
    isSameStyle = (0, _utilJs.setCurrentStyle)(currentStyle, "bold", optionBold);
    currentStyle = "bold";
    if (isSameStyle) currentStyle = "none";
});
optionItalics.addEventListener("click", ()=>{
    currentInputStackLength = formInputValue.length;
    isSameStyle = (0, _utilJs.setCurrentStyle)(currentStyle, "italics", optionItalics);
    currentStyle = "italics";
    if (isSameStyle) currentStyle = "none";
});
optionStrikeThrough.addEventListener("click", ()=>{
    currentInputStackLength = formInputValue.length;
    isSameStyle = (0, _utilJs.setCurrentStyle)(currentStyle, "strikeThrough", optionStrikeThrough);
    currentStyle = "strikeThrough";
    if (isSameStyle) currentStyle = "none";
});
optionCode.addEventListener("click", ()=>{
    currentInputStackLength = formInputValue.length;
    isSameStyle = (0, _utilJs.setCurrentStyle)(currentStyle, "code", optionCode);
    currentStyle = "code";
    if (isSameStyle) currentStyle = "none";
});
...
formInput.addEventListener("keydown", (event)=>{
    if (event.key === "Backspace" && formInputValue.length !== 0) {
        textWithDeletedLetter = (0, _utilJs.handleBackSpace)(formInputValue.at(-1));
        formInputValue.pop();
        if (textWithDeletedLetter !== null) formInputValue.push(textWithDeletedLetter);
    }
    if (event.key.length === 1) {
        if (formInputValue.length > currentInputStackLength) formInputValue.pop();
        switch(currentStyle){
            case "none":
                stackValue = (0, _utilJs.handleFormText)(event.key, "none");
                break;
            case "bold":
                stackValue = (0, _utilJs.handleFormText)(event.key, "bold");
                break;
            case "italics":
                stackValue = (0, _utilJs.handleFormText)(event.key, "italics");
                break;
            case "strikeThrough":
                stackValue = (0, _utilJs.handleFormText)(event.key, "strikeThrough");
                break;
            case "code":
                stackValue = (0, _utilJs.handleFormText)(event.key, "code");
        }
...
},{"./util.js":"jqgAC"}],"jqgAC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addStyle", ()=>addStyle);
parcelHelpers.export(exports, "setCurrentStyle", ()=>setCurrentStyle);
parcelHelpers.export(exports, "handleFormText", ()=>handleFormText);
parcelHelpers.export(exports, "handleBackSpace", ()=>handleBackSpace);
parcelHelpers.export(exports, "handleEmoji", ()=>handleEmoji);
"use strict";
...
function setCurrentStyle(currentStyle, style, stylize) {
...
function handleBackSpace(lastItem) {
    const indexOfCloseBracket = lastItem.indexOf(">");
    const indexOfOpenBracket = lastItem.lastIndexOf("<");
    const tagValue = lastItem.slice(indexOfCloseBracket + 1, indexOfOpenBracket).slice(0, -1);
    const value = `${lastItem.slice(0, indexOfCloseBracket + 1)}${tagValue}${lastItem.slice(indexOfOpenBracket, lastItem.length + 1)}`;
    if (!tagValue) {
        formInputTextValue = "";
        return null;
    }
...
},{}]},["2UeK4","bB7Pu"], "bB7Pu", "parcelRequire2bdc")
